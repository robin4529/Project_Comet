          ...
          <div class="row">
              <?php 
                if(isset($_GET['slug'])){
                    ...
                    $product = $product_data->fetch_object();
            ...
            <div class="col-md-5 col-md-offset-1">
              <div class="title mt-0">
                <h2><?php echo $product->name; ?><span class="red-dot"></span></h2>
               </div>
              <div class="single-product-price">
                <div class="row">
                  <div class="col-xs-6">
                    <h3><del><?php echo $product->price, 'taka' ?></del>
                    <span><?php echo $product->sprice; 'taka' ?></span>
                    
                  </div>
                  <div class="col-xs-6 text-right">
                    <span class="rating-stars"><i class="ti-star full"></i>
                    <i class="ti-star full"></i><i class="ti-star full">

                    </i><i class="ti-star full"></i><i class="ti-star">

                    </i><span class="hidden-xs">(3 Reviews)</span></span>
                  </div>
                </div>
              </div>
