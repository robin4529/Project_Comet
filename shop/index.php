        ...
        <div class="row">
          <div class="col-md-3 hidden-sm hidden-xs">
            ...
            <div class="widget method='Get'">
              ...
              <div class="widget">
                ...
                <ul class="nav">
                <li><a href="?">All</a></li>
                  <li><a href="?cat=women">Saree</a>
                  </li>
                  <li><a href="?cat=men">Tshirt</a>
                  </li>
                  <li><a href="?cat=men">LETHER JACKET</a>
                  </li>
                  <li><a href="?cat=men">Denim Jacket</a>
                  </li>
                  <li><a href="?cat=Men">GENTELMEN SHIRT</a>
                  </li>
                  <li><a href="?cat=men">TSHIRT</a>
                  </li>
                </ul>
              ...
              <div class="widget">
                ...
                <ul class="nav product-list">
                  ...
                  <div class="product-thumbnail">
                    ...
                    <div class="product-summary"><a href="#"><?php echo $product->name ?></a>
          ...
          <div class="col-md-9">
            ...
            <div class="container-fluid">
              <div class="row">
                  <?php
                          $products=all('products','DESC');

                            if(isset($_GET['cat'])){
                              $cat = $_GET['cat'];

                              $products =connect()->query("SELECT* FROM products WHERE category ='$cat'");
                            }
                            if(isset($_GET['s'])){
                              $serach = $_GET['s'];

                        $products =connect()->query("SELECT* FROM products WHERE name like'%$serach%'");
                            }
                ...
                <div class="col-md-4 col-sm-6">
                  <div class="shop-product">
                    <div class="product-thumb">
                      <a href="singel.php?slug=<?php echo $product->slug; ?>">
                        <img style="height:300px;" src="../media/products/<?php echo $product->photo; ?>" alt="">
                      </a>
                      <div class="product-overlay"><a href="#" class="btn btn-color-out btn-sm">Add To Cart<i class="ti-bag"></i></a>
                      </div>
                    </div>
                    <div class="product-info">
                      <h4 class="upper"><a href="#"><?php echo $product->name; ?>
                    </a></h4><span><?php echo $product->price; 'taka' ?></span>
                    </a></h4><span><?php echo $product->sprice; 'taka' ?></span>
